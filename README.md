...
| Platform | | |
|---|---|---|
| **macOS** — Apple Silicon (M1–M4) | [`.dmg`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_aarch64.dmg) | |
| **macOS** — Intel | [`.dmg`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_x64.dmg) | |
| **Windows** | [`.exe`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_x64-setup.exe) | [`.msi`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_x64_en-US.msi) |
| **Linux** | [`.AppImage`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_amd64.AppImage) | [`.deb`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba_0.6.0_amd64.deb) · [`.rpm`](https://github.com/nuvocode/verba/releases/download/v0.6.0/Verba-0.6.0-1.x86_64.rpm) |
